...
const Header = () => {
  return (
    <SectionWrapper>
        <div>
          <div className="circleBlur z-0"></div>
          <div className="w-[1463px] flex justify-around items-center mt-[150px] mb-20 border border-[#0A0C0F] rounded-full bg-[#0A0C0F] -z-10">
            <div>
